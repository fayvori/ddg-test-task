...
Для gre интерфесов был выбран mtu 1472 по следующим соображениям:

1. 1500 (default) - 20 outer ipv4 header + 4 (gre overhead) = 1472
...
По завершению работы можно выполнить `make clean` чтобы удалить все виртуалки, сеть `iperf-net` и build/
